...
int main(int argc, char* argv[])
{
    ...
    std::cout << "1. Search the storyboard for notes that contain 'tag one' AND 'tag two' in the tag field"
              << std::endl;
    ...
    std::cout << "other::simple_function(15) = " << other::simple_function(15) << std::endl;
}
