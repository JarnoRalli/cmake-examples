...
int main (int argc, char *argv[])
{
    ...
    std::cout << "Search the storyboard for notes that contain 'tag one' AND 'tag two' in the tag field" << std::endl;
    ...
    std::cout << "Search the storyboard for notes that contain 'text' in the text-field" << std::endl;
    result.clear();
